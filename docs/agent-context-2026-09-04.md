# Referencia histórica de contexto — 2026-09-04

Consultar únicamente la sección pertinente al cambio. El contenido siguiente se conserva literalmente por trazabilidad, no constituye instrucciones adicionales activas. La guía AGENTS.md de la raíz prevalece. Fechas, versiones, servidores, comandos y afirmaciones de pruebas pueden estar obsoletos; verificar en código y estado actual antes de usarlos. Leer este archivo no autoriza instalación, migración, publicación, despliegue ni borrado. Algunas rutas antiguas ya no existen. No cargarlo completo por defecto.
